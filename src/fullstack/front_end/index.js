        ...
        <div style={{ display: 'flex', gap: 80, alignItems: 'center', maxWidth: 1060, width: '100%' }}>
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ fontFamily: "'DM Sans'", fontWeight: 300, fontSize: 44, lineHeight: 1.2, color: C.white, marginBottom: 16 }}>
              Order Book<br />
              <span style={{ color: C.accent, fontWeight: 600 }}>Analyzer</span><br />
              for Prediction Markets
            </h1>
            <p style={{ fontSize: 15, color: C.muted, lineHeight: 1.7, maxWidth: 420, marginBottom: 32 }}>
...
ReactDOM.createRoot(document.getElementById('app-root')).render(<HomeScreen />);
